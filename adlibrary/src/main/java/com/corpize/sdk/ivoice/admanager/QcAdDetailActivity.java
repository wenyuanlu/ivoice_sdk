...
import com.corpize.sdk.ivoice.utils.StatusBarUtil;
...
public class QcAdDetailActivity extends Activity {
    ...
    private String         TAG = "QcAdDetailActivity";
    ...
    private       boolean       mIsInitiativeCancel;//是否主动点击使dialog消失
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        //获取控件
        mTvTitle = findViewById(R.id.tv_qcad_title);
        mBack = findViewById(R.id.iv_qcad_back);
        mClose = findViewById(R.id.iv_qcad_close);
        mWebView = findViewById(R.id.web_qcad_view);
        mProgressBar = findViewById(R.id.progressbar_qcad);
        mRlToolbar = findViewById(R.id.rl_qcad_detail_title);

        if (!TextUtils.isEmpty(titleColor)) {
            mTvTitle.setTextColor(Color.parseColor(titleColor));
        }
        if (!TextUtils.isEmpty(backgroundColor)) {
            mRlToolbar.setBackgroundColor(Color.parseColor(backgroundColor));
    ...
    private void initData () {
        ...
        if (!TextUtils.isEmpty(mUrl)) {
            if (mUrl.startsWith("http") ||
                ...
                if (!CommonClickWebViewUtils.openCommonExternal(QcAdDetailActivity.this, mUrl)) {
                    finish();
                }
            }
        }
            ...
            try {
                if (!TextUtils.isEmpty(url)) {
                    ...
                    if (uri.getScheme().equals("http") ||
                        ...
                        CommonClickWebViewUtils.openCommonExternal(QcAdDetailActivity.this, url);
                        return true;
                    }
                }
            } catch (Exception e) {
