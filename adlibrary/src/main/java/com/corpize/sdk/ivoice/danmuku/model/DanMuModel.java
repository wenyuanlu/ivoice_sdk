package com.corpize.sdk.ivoice.danmuku.model;
...
public class DanMuModel implements OnDanMuViewTouchListener {
    ...
    public final static int NORMALCLICK = 150;
    ...
    private float xLeftPosition = 0;//绘制的X轴的实际位置
    private float yLeftPosition = 0;//绘制的Y轴的实际位置
    ...
    public void setPriority (int priority) {
        if (priority != NORMAL && priority != SYSTEM && priority != NORMALCLICK) {
    ...
    public float getxLeftPosition () {
        return xLeftPosition;
    }

    public void setxLeftPosition (float xLeftPosition) {
        this.xLeftPosition = xLeftPosition;
    }

    public float getyLeftPosition () {
        return yLeftPosition;
    }

    public void setyLeftPosition (float yLeftPosition) {
        this.yLeftPosition = yLeftPosition;
    }
}
