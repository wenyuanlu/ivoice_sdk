...
public class HttpLogUtil {
    ...
    public static        String  customTagPrefix = "QcCompoundAdHttp"; // 自定义Tag的前缀
    private static final boolean isSaveLog       = false; // 是否把保存日志到SD卡中
    private static final boolean isShowLog       = Constants.IS_SHOW_HTTP_LOG; // 是否展示日志
    public static final  String  ROOT            = Environment.getExternalStorageDirectory().getPath() + "/logs/"; // SD卡中的根目录
    ...
    public static boolean allowD   = isShowLog;
    public static boolean allowE   = isShowLog;
    public static boolean allowI   = isShowLog;
    public static boolean allowV   = isShowLog;
    public static boolean allowW   = isShowLog;
    public static boolean allowWtf = isShowLog;
    ...
    public static boolean isSDAva () {
        if (Environment.getExternalStorageState()
                .equals(Environment.MEDIA_MOUNTED) || Environment.getExternalStorageDirectory().exists()) {
            return true;
        } else {
            return false;
        }
