...
public class GPSUtils {
    ...
    private        int             mTimeOut  = 5 * 60 * 1000; //间隔5分钟定位一次
    ...
    public void initLngAndLat () {
        try {
            getLngAndLat(new OnLocationResultListener() {
                @Override
     ...
     * 获取经纬度,回调接口返回经纬度
     */
    public void getLngAndLat (final OnLocationResultListener onLocationResultListener) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(locationProvider)) {
                ...
                if (locationDefault != null) {
                    ...
                    double altitude = locationDefault.getAltitude();
                    AppUserBean.getInstance().setAltitude(altitude);
                    ...
                    if (locationProvider.equals(LocationManager.GPS_PROVIDER)) {
                        ...
                        if (mOnLocationListener != null && locationNetWork != null) {
                            ...
                            double altitude = locationNetWork.getAltitude();
                            AppUserBean.getInstance().setAltitude(altitude);
                        } else {
