...
public class NetUtil {
    ...
    public static int getNetworkState (Context context) {
        if (!PermissionUtil.checkPermission(context, android.Manifest.permission.ACCESS_NETWORK_STATE)
                && !PermissionUtil.checkPermission(context, android.Manifest.permission.READ_PHONE_STATE)) {
