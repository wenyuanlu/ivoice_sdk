...
public class MyTextureView extends TextureView {
            ...
            try {
                ...
                mMediaPlayer.setOnVideoSizeChangedListener(new MediaPlayer.OnVideoSizeChangedListener() {
                    ...
                    public void onVideoSizeChanged (MediaPlayer mp, int width, int height) {
                        ...
                        updateTextureViewSizeCenter(false);
    ...
    private MediaPlayer.OnPreparedListener mPreparedListener = new MediaPlayer.OnPreparedListener() {
        ...
        public void onPrepared (MediaPlayer mp) {
            ...
            if (isPlay) {
                ...
                if (mVideoOnListener != null) {
                    mVideoOnListener.OnPreparedListener(mp, duration, time);
                }
            }
     ...
     */
    public void updateTextureViewSizeCenter (boolean isHorizatial) {
        int width  = 1;
        int height = 1;
        if (isHorizatial) {
            width = getHeight();
    ...
    public interface MyTextureViewOnListener {
        ...
        void OnPreparedListener (MediaPlayer mp, int duration, int secondtime);
