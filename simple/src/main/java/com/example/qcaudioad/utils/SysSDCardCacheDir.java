...
public class SysSDCardCacheDir {
    private static final String rootDir = "ivoice";// 缓存根目录
    ...
    public static final File getRootDir() {
        File file = null;
        if (isSdCardExist()) {
            file = new File(BaseApplication.getInstance().getExternalFilesDir(null)
    ...
    public static final String getLogPath() {
        ...
        if (isSdCardExist()) {
            sb.append(BaseApplication.getInstance().getExternalFilesDir(null).getAbsolutePath());
            sb.append("/");
            sb.append(rootDir);
            sb.append("/");
            sb.append(logDir);
